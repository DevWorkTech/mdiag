# Транспорт 7.00.014-mdiag2

Основной вход использует OkHttp. Исправление Apache относится к другому стеку.
Текущая реализация и диагностика: [REWORK_TRANSPORT_RU.md](../REWORK_TRANSPORT_RU.md).
